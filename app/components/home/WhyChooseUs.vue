...
const d = homeData.whyChooseUs
</script>

<template>
  <section class="section-soft why-section" aria-labelledby="why-title">
    <div class="container">
